      ...
      <div className="min-h-full flex flex-col bg-background">
        ...
        <div className="px-5 mt-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button className="py-3 rounded-xl border border-border bg-card text-sm font-semibold">
              Google
            </button>
            <button className="py-3 rounded-xl border border-border bg-card text-sm font-semibold">
              Apple
          ...
          <p className="text-center text-xs text-muted-foreground pt-2 pb-6">
            By continuing you agree to our <span className="text-primary font-semibold">Terms</span>{" "}
