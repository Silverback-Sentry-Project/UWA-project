      ...
      <div className="min-h-full flex flex-col bg-background">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-7 text-center">
          ...
          <p className="text-muted-foreground text-sm mt-2 leading-relaxed">
            Thank you for helping protect wildlife. Rangers have been notified and will follow up
            shortly.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  You can file a compensation claim now or anytime later from the dashboard. This
                  step is optional.
                </p>
              </div>
            </div>
        ...
        <div className="px-6 pb-10 pt-4 space-y-3">
          ...
          <Link
            to="/community"
            className="w-full bg-secondary text-foreground py-4 rounded-2xl font-semibold flex items-center justify-center gap-2"
          >
