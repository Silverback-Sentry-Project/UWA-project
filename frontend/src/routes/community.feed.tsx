...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt:
      "Practical advice from rangers in Murchison Falls on protecting crops without harming wildlife.",
    time: "8 min read",
    grad: "gradient-sunset",
  },
  {
    tag: "Stories",
    title: "From farmer to community ranger",
    excerpt: "A profile of Joseph, who turned conflict into stewardship for his entire sub-county.",
    time: "6 min read",
    grad: "gradient-sky",
  },
];
